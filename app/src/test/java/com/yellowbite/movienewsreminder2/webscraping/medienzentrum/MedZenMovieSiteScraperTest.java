...
public class MedZenMovieSiteScraperTest
{
    ...
    private static final String DANCE_WITH_ME_LINK = "https://opac.winbiap.net/mzhr/detail.aspx?data=U29ydD1FcnNjaGVpbnVuZ3NqYWhyJmFtcDtzQz1jXzA9MSUlbV8wPTElJWZfMD0yJSVvXzA9OCUldl8wPXdvcmtvdXQrK2NfMT0xJSVtXzE9MSUlZl8xPTQyJSVvXzE9MSUldl8xPTQ2Uy1EVkQgKFNwaWVsZmlsbSkmYW1wO2NtZD0xJmFtcDtDYXRhbG9ndWVJZD04OTYxNCZhbXA7cGFnZUlkPTImYW1wO1NyYz0yJmFtcDtwUz0xMA==-BNobu7LWRRY=";
    ...
    public void testGetMovie()
    {
        ...
        try
        {
            siteScraper = new MedZenMovieSiteScraper(DANCE_WITH_ME_EXPECTED.getLink());
        } catch (IOException e)
        {
            e.printStackTrace();
            return;
